...
function dispatchWithAutoDismiss(action: Action) {
  _origDispatch(action);
  if (action.type === "ADD_TOAST") {
    addToRemoveQueue(action.toast.id, _origDispatch);
  }
}

// Patch toast to use auto-dismiss
Object.assign(toast, {});
// Re-export dispatch patched
export { dispatchWithAutoDismiss as _dispatch };
